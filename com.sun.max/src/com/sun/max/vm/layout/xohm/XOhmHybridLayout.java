...
/**
 * Identical to {@link OhmHybridLayout}.
 */
public final class XOhmHybridLayout extends XOhmArrayLayout implements HybridLayout {
    ...
    private final XOhmTupleLayout tupleLayout;
    private final XOhmArrayLayout intArrayLayout;


    XOhmHybridLayout() {
        super(Kind.WORD);
        tupleLayout = new XOhmTupleLayout();
        intArrayLayout = new XOhmArrayLayout(Kind.INT);
    }
