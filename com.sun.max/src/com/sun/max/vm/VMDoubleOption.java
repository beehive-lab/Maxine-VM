...
public class VMDoubleOption extends VMOption {
     ...
     */
    @HOSTED_ONLY
    public VMDoubleOption(String prefix, double defaultValue, String help) {
        super(prefix, appendDefaultValue(help, String.valueOf(defaultValue)));
        value = defaultValue;
    }

    /**
     * Parses a C-style string to produce a double value for this option.
     *
    ...
    public boolean parseValue(Pointer optionValue) {
        value = CString.parseDouble(optionValue);
    ...
    /**
     * Gets the value of this option as an {@code double}.
