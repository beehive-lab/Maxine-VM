...
public class JDK {
    ...
    public static final ClassRef sun_launcher_LauncherHelper         = new ClassRef(sun.launcher.LauncherHelper.class);
    ...
    public static final ClassRef sun_misc_URLClassPath               = new ClassRef(sun.misc.URLClassPath.class);
    ...
    public static final ClassRef sun_misc_Launcher$ExtClassLoader    = new LazyClassRef(sun.misc.Launcher.class, "ExtClassLoader");
