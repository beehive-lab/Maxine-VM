...
/**
 * Describes a stack frame for a RISCV64 method whose frame conforms with the JVMS.
 ...
 */
public class RISCV64JVMSFrameLayout extends JVMSFrameLayout {
    ...
    public RISCV64JVMSFrameLayout(TargetMethod targetMethod) {
        super(targetMethod.classMethodActor());
        /*
         * The use of STACK_SLOT_SIZE (set to Word.size() in VMFrameLayout) is a little misleading.
         * Recall that the SP in riscv64 must be 16 byte aligned at external interfaces and to
    ...
    public RISCV64JVMSFrameLayout(ClassMethodActor classMethodActor, int numberOfTemplateSlots) {
        super(classMethodActor);
        this.numberOfTemplateSlots = numberOfTemplateSlots;
    }

    public RISCV64JVMSFrameLayout(int numberOfLocalSlots, int numberOfOperandStackSlots, int numberOfParameterSlots, int numberOfTemplateSlots) {
