 ...
 *
 * @see RISCV64JVMSFrameLayout
 */
@HOSTED_ONLY
public class RISCV64JVMSFrame extends JVMSFrame {

    private final Pointer localVariablesBase;

    public RISCV64JVMSFrame(StackFrame callee, TargetMethod targetMethod, Pointer instructionPointer,
    ...
    public boolean isSameFrame(StackFrame stackFrame) {
        if (stackFrame instanceof RISCV64JVMSFrame) {
            final RISCV64JVMSFrame jvmsStackFrame = (RISCV64JVMSFrame) stackFrame;
