 ...
 */
public interface SingletonViewManager<Inspector_Kind extends InspectorView> extends ViewManager<Inspector_Kind> {
     ...
     */
    InspectorView<Inspector_Kind> activateView();
