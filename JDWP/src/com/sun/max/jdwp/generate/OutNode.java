 ...
 * Company, Ltd.
 */
/*VCSID=52ae1ea2-3248-4539-8263-4be362c60453*/
...
class OutNode extends AbstractTypeListNode {
    ...
    void set(String kind, List<Node> components, int lineno) {
        ...
        components.add(0, new NameNode("IncomingRequest"));
    }
    ...
    void genJava(PrintWriter writer, int depth) {
        ...
        indent(writer, depth);
        writer.write("public static class IncomingRequest implements IncomingData {");
        genJavaReadingClassBody(writer, depth + 1, "IncomingRequest");
        indent(writer, depth);
        writer.write("}");
        writer.println();
    }
