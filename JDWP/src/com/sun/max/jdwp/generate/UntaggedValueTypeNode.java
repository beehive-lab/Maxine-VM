 ...
 * Company, Ltd.
 */
/*VCSID=c3593d05-286b-40b9-8dc2-d7afb87e18c7*/
 ...
 */
class UntaggedValueTypeNode extends SimpleTypeNode {

    public UntaggedValueTypeNode() {
        super("untagged-value", "JDWPValue", "ps.readUntaggedValue()");
    }

    @Override
    public void genJavaWrite(PrintWriter writer, int depth, String writeLabel) {
        indent(writer, depth);
        writer.println("ps.writeUntagged(" + writeLabel + ");");
    }
