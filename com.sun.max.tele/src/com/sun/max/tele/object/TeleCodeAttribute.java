...
public class TeleCodeAttribute extends TeleTupleObject {
    ...
    public final byte[] readBytecodes() {
        ...
        final RemoteReference byteArrayReference = fields().CodeAttribute_code.readRemoteReference(reference());
    ...
    public final TeleConstantPool getTeleConstantPool() {
        final RemoteReference constantPoolReference = fields().CodeAttribute_cp.readRemoteReference(reference());
