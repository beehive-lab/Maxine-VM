...
public class TeleMethod extends TeleTupleObject {
    ...
    protected TeleMethod(TeleVM vm, RemoteReference methodReference) {
    ...
    public Method toJava() {
        if (method == null) {
            final RemoteReference methodActorReference = fields().Method_methodActor.readRemoteReference(reference());
