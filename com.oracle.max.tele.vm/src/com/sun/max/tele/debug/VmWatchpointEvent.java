 ...
 * Immutable (thread-safe) record of a thread triggering a memory watchpoint in the VM.
  */
public class VmWatchpointEvent implements MaxWatchpointEvent {
    ...
    public VmWatchpointEvent(MaxWatchpoint maxWatchpoint, TeleNativeThread teleNativeThread, Address address, int code) {
