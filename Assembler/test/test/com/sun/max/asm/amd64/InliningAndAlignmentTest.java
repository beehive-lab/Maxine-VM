 ...
 * Company, Ltd.
 */
/*VCSID=7e4f372f-f0ed-4568-bcd0-7a4191a83452*/
...
public class InliningAndAlignmentTest extends MaxTestCase {
    ...
    /**
     * The assembly code in this example was once generated by the optimizing compiler of the Maxine VM for method 'ExpiringCache.<init>()'.
     * And then the alignment did not work. The 'jmp' instruction turned out to be only 2 bytes long.
     */
    private byte[] assembleExpiringCacheInit(long startAddress) throws IOException, AssemblyException {
    ...
    private final long _startAddress = 0x1234567812345678L;
    ...
    private byte[] assembleSwitchTable(long startAddress, InlineDataRecorder inlineDataRecorder) throws IOException, AssemblyException {
        ...
        asm.directives().align(4);
        asm.bindLabel(case1);
        asm.mov(RCX, 0xDEADBEEFDEADBEEFL);
        asm.jmp(skip);
        ...
        asm.bindLabel(case3);
        asm.mov(RCX, 0xFFFFFFFFFFFFFFFFL);
        asm.jmp(skip);
