...
public class C1XCompiler extends ObservableCompiler implements CiCompiler {
    ...
    private boolean omitStub(CompilerStub.Id id) {
        if ((Platform.target().arch.isARM() || Platform.target().arch.isAarch64()) && (id == CompilerStub.Id.fneg || id == CompilerStub.Id.dneg || id == CompilerStub.Id.d2l || id == CompilerStub.Id.f2l)) {
            return true;
        }
