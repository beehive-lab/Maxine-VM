...
public class MaxXirGenerator implements RiXirGenerator {
    ...
    private static boolean LogXirPrologueGeneration = false;

    static {
        addFieldOption("-XX:", "LogXirPrologueGeneration", MaxXirGenerator.class,
                "Log the methods for which a prologue has been generated by the MaxXirGenerator (default: false)");
    }
    ...
    public XirSnippet genPrologue(XirSite site, RiResolvedMethod method) {
        ...
        if (MaxineVM.isRunning()) {
            if (LogXirPrologueGeneration) {
                Log.print("genPrologue for method = ");
                Log.println(method);
            }
