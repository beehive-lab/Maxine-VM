 ...
 * 
 * Class to unify constructors and methods as they are separated in the reflection API. Here, dynamic AOP to add an interface would be nice!
 *
 */
public final class InvokeTarget {
	...
	protected InvokeTarget(String name, String signature,
			Class<?> declaringClass, int modifiers) {
		this.name = name;
