...
SOURCES = $(OS_SOURCES) address.c boxedMemory.c boxedPointer.c c.c log.c tele.c mutex.c threadLocals.c threads.c $(ISA).c platform.c relocation.c dataio.c virtualMemory.c
