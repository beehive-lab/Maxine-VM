...
Java_com_sun_max_tele_channel_agent_guestvm_db_AgentGuestVMDBTeleChannelProtocol_teleThreadLocalsInitialize(JNIEnv *env, jclass c, jint threadLocalsSize) {
...
Java_com_sun_max_tele_debug_guestvm_db_GuestVMNativeDBTeleChannelProtocol_nativeAttach(JNIEnv *env, jclass c, jint domainId, jlong extra1) {
    tele_log_println("Calling do_attach on domId=%d", domainId);
    return db_attach(domainId);
}

JNIEXPORT jboolean JNICALL
Java_com_sun_max_tele_debug_guestvm_db_GuestVMNativeDBTeleChannelProtocol_nativeDetach(JNIEnv *env, jclass c) {
...
JNIEXPORT jboolean JNICALL
Java_com_sun_max_tele_debug_guestvm_db_GuestVMNativeDBTeleChannelProtocol_nativeSuspendAll(JNIEnv *env, jclass c) {
	suspend_all_request = 1;
	return true;
}

JNIEXPORT jlong JNICALL
Java_com_sun_max_tele_debug_guestvm_db_GuestVMNativeDBTeleChannelProtocol_nativeSuspend(JNIEnv *env, jclass c, jint threadId) {
    db_suspend(threadId);
    return 1;
}

JNIEXPORT jboolean JNICALL
Java_com_sun_max_tele_debug_guestvm_db_GuestVMNativeDBTeleChannelProtocol_nativeSingleStep(JNIEnv *env, jclass c, jint threadId) {
...
Java_com_sun_max_tele_debug_guestvm_db_GuestVMNativeDBTeleChannelProtocol_nativeSetInstructionPointer(JNIEnv *env, jclass c, jint threadId, jlong ip) {
    return db_set_ip(threadId, ip);
}

JNIEXPORT jboolean JNICALL
Java_com_sun_max_tele_debug_guestvm_db_GuestVMNativeDBTeleChannelProtocol_nativeReadRegisters(JNIEnv *env, jclass c, jint threadId,
...
JNIEXPORT jboolean JNICALL
Java_com_sun_max_tele_debug_guestvm_db_GuestVMNativeDBTeleChannelProtocol_nativeGatherThreads(JNIEnv *env, jclass c, jobject teleDomain, jobject threadSeq, jlong threadLocalsList, jlong primordialThreadLocals) {
...
JNIEXPORT jboolean JNICALL
Java_com_sun_max_tele_debug_guestvm_db_GuestVMNativeDBTeleChannelProtocol_nativeResume(JNIEnv *env, jobject domain) {
...
JNIEXPORT jlong JNICALL
Java_com_sun_max_tele_debug_guestvm_db_GuestVMNativeDBTeleChannelProtocol_nativeGetBootHeapStart(JNIEnv *env, jclass c) {
    return db_app_specific1(0);
}

JNIEXPORT jint JNICALL
Java_com_sun_max_tele_debug_guestvm_db_GuestVMNativeDBTeleChannelProtocol_nativeSetTransportDebugLevel(JNIEnv *env, jclass c, jint level) {
    return db_debug(level);
}

JNIEXPORT jint JNICALL
Java_com_sun_max_tele_debug_guestvm_db_GuestVMNativeDBTeleChannelProtocol_nativeReadBytes(JNIEnv *env, jclass c, jlong src, jobject dst, jboolean isDirectByteBuffer, jint dstOffset, jint length) {
    return teleProcess_read(&db_memory_handler, env, c, src, dst, isDirectByteBuffer, dstOffset, length);
}

JNIEXPORT jint JNICALL
Java_com_sun_max_tele_debug_guestvm_db_GuestVMNativeDBTeleChannelProtocol_nativeWriteBytes(JNIEnv *env, jclass c, jlong dst, jobject src, jboolean isDirectByteBuffer, jint srcOffset, jint length) {
    return teleProcess_write(&db_memory_handler, env, c, dst, src, isDirectByteBuffer, srcOffset, length);
}

JNIEXPORT jint JNICALL
Java_com_sun_max_tele_debug_guestvm_db_GuestVMNativeDBTeleChannelProtocol_nativeMaxByteBufferSize(JNIEnv *env, jclass c) {
	return db_multibytebuffersize();
}

JNIEXPORT jboolean JNICALL
Java_com_sun_max_tele_debug_guestvm_db_GuestVMNativeDBTeleChannelProtocol_nativeActivateWatchpoint(JNIEnv *env, jclass c, jlong address, jlong size, jboolean after, jboolean read, jboolean write, jboolean exec) {
    int kind = 0;
...
JNIEXPORT jboolean JNICALL
Java_com_sun_max_tele_debug_guestvm_db_GuestVMNativeDBTeleChannelProtocol_nativeDeactivateWatchpoint(JNIEnv *env, jclass c, jlong address, jlong size) {
...
JNIEXPORT jlong JNICALL
Java_com_sun_max_tele_debug_guestvm_db_GuestVMNativeDBTeleChannelProtocol_nativeReadWatchpointAddress(JNIEnv *env, jclass c) {
...
JNIEXPORT jint JNICALL
Java_com_sun_max_tele_debug_guestvm_db_GuestVMNativeDBTeleChannelProtocol_nativeReadWatchpointAccessCode(JNIEnv *env, jclass c) {
	int thread_id = get_wp_thread();
	int kind;
	if (thread_id < 0) {
