 ...
 * @param primordialTLA the primordial TLA in the VM's address space
 ...
 */
extern TLA teleProcess_findTLA(ProcessHandle ph, Address tlaList, Address primordialTLA, Address stackPointer, TLA tlaCopy, NativeThreadLocals ntlCopy);
