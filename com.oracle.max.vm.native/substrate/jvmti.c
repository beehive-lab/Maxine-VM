...
Java_com_oracle_max_vm_ext_jvmti_JVMTICallbacks_invokeAgentOnLoad(JNIEnv *env, jclass c, Agent_OnLoad_t Agent_OnLoad, char *options) {
    return (*Agent_OnLoad)((JavaVM *) &main_vm, options, NULL);
}

JNIEXPORT jint JNICALL
Java_com_oracle_max_vm_ext_jvmti_JVMTICallbacks_invokeAgentOnUnLoad(JNIEnv *env, jclass c, Agent_OnUnLoad_t Agent_OnUnLoad) {
    return (*Agent_OnUnLoad)((JavaVM *) &main_vm);
}

JNIEXPORT void JNICALL
Java_com_oracle_max_vm_ext_jvmti_JVMTICallbacks_invokeStartFunction(JNIEnv *env, jclass c, jvmtiStartFunction callback, jvmtiEnv *jvmti_env, void *arg) {
    (*callback)(jvmti_env, env, arg);
}

JNIEXPORT void JNICALL
Java_com_oracle_max_vm_ext_jvmti_JVMTICallbacks_invokeStartFunctionNoArg(JNIEnv *env, jclass c, jvmtiStartFunctionNoArg callback, jvmtiEnv *jvmti_env) {
    (*callback)(jvmti_env, env);
}

JNIEXPORT void JNICALL
Java_com_oracle_max_vm_ext_jvmti_JVMTICallbacks_invokeGarbageCollectionCallback(JNIEnv *env, jclass c, GarbageCollectionCallback callback, jvmtiEnv *jvmti_env) {
    (*callback)(jvmti_env);
}

JNIEXPORT void JNICALL
Java_com_oracle_max_vm_ext_jvmti_JVMTICallbacks_invokeThreadObjectCallback(JNIEnv *env, jclass c, ThreadObjectCall callback, jvmtiEnv *jvmti_env, jthread thread, jobject object) {
    (*callback)(jvmti_env, env, thread, object);
}

JNIEXPORT void JNICALL
Java_com_oracle_max_vm_ext_jvmti_JVMTICallbacks_invokeClassfileLoadHookCallback(JNIEnv *env, jclass c, jvmtiEventClassFileLoadHook callback, jvmtiEnv *jvmti_env,
...
JNIEXPORT void JNICALL
Java_com_oracle_max_vm_ext_jvmti_JVMTICallbacks_invokeFieldWatchCallback(JNIEnv *env, jclass c, void *callback,
                jvmtiEnv *jvmti_env,
...
JNIEXPORT jint JNICALL
Java_com_oracle_max_vm_ext_jvmti_JVMTICallbacks_invokeHeapIterationCallback(JNIEnv *env, jclass c, jvmtiHeapIterationCallback callback,
...
JNIEXPORT void JNICALL
Java_com_oracle_max_vm_ext_jvmti_JVMTICallbacks_invokeBreakpointCallback(JNIEnv *env, jclass c, jvmtiEventBreakpoint callback,
...
JNIEXPORT void JNICALL
Java_com_oracle_max_vm_ext_jvmti_JVMTICallbacks_invokeFramePopCallback(JNIEnv *env, jclass c, jvmtiEventFramePop callback,
                jvmtiEnv *jvmti_env, jthread thread,
...
JNIEXPORT void JNICALL
Java_com_oracle_max_vm_ext_jvmti_JVMTICallbacks_invokeExceptionCallback(JNIEnv *env, jclass c, void *callbackX,
...
JNIEXPORT void JNICALL
Java_com_oracle_max_vm_ext_jvmti_JVMTICallbacks_invokeCompiledMethodLoadCallback(JNIEnv *env, jclass c, jvmtiEventCompiledMethodLoad callback,
...
JNIEXPORT void JNICALL
Java_com_oracle_max_vm_ext_jvmti_JVMTICallbacks_invokeCompiledMethodUnloadCallback(JNIEnv *env, jclass c, jvmtiEventCompiledMethodUnload callback,
