/*
 * Copyright (c) 2011 Hewlett-Packard Company. All rights reserved. DO NOT ALTER OR REMOVE COPYRIGHT NOTICES OR THIS
 * FILE HEADER.
 *
 ...
 * @Harness: java
 * @Runs: 1 = 5986; 2 = -9039; 3 = 4; 4 = 3; 5 = 6; 6 = 14680079; 7 = 16393;
 */
...
public class Test5091921 {
    ...
    /*
     * Test for range check elimination with bit flip issue for scale*i+offset<limit where offset is not 0
     */
    ...
    /*
     * Test for range check elimination with bit flip issue for scale*i<limit where scale > 1
     */
    ...
    public static int test(int t) {
        ...
        switch (t) {
            ...
            case 2:
                return test2();
            case 3:
                return test_wrap1(0x7fffffff);
            case 4:
                return test_rce5(box5, 0x80000100);
            case 5:
                return test_rce6(box6, 0x80000100);
            case 6:
                return test_rce7(box7);
            case 7:
                return test_rce8(box8);
        }
        return -1;
    }
