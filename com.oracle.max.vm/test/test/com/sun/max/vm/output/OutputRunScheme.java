 ...
 */
public class OutputRunScheme extends AbstractTestRunScheme {
    ...
    public void initialize(MaxineVM.Phase phase) {
        if (phase == MaxineVM.Phase.STARTING) {
            ...
            if (phase == MaxineVM.Phase.BOOTSTRAPPING) {
                Class<?>[] testClasses = MaxineTesterConfiguration.findOutputTests("test.vmoutput.");
