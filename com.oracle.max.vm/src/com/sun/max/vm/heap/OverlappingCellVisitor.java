...
/**
 * Interface for visiting a cell that overlap a region.
 *
 */
public interface OverlappingCellVisitor {
    /**
     * Apply a visitor to a cell that overlaps a region of memory.
     ...
     */
    Pointer visitCell(Pointer cell, Address start, Address end);
}
