...
public class ARMV7JVMSFrameLayout extends JVMSFrameLayout {
    ...
    public ARMV7JVMSFrameLayout(TargetMethod targetMethod) {
    ...
    public ARMV7JVMSFrameLayout(ClassMethodActor classMethodActor, int numberOfTemplateSlots) {
        super(classMethodActor);
        this.numberOfTemplateSlots = numberOfTemplateSlots;
    }

    public ARMV7JVMSFrameLayout(int numberOfLocalSlots, int numberOfOperandStackSlots, int numberOfParameterSlots, int numberOfTemplateSlots) {
