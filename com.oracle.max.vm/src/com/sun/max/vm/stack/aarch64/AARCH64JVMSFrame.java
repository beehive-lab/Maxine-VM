 ...
 *
 * @see AARCH64JVMSFrameLayout
 */
@HOSTED_ONLY
public class AARCH64JVMSFrame extends JVMSFrame {

    private final Pointer localVariablesBase;

    public AARCH64JVMSFrame(StackFrame callee, TargetMethod targetMethod, Pointer instructionPointer,
    ...
    public boolean isSameFrame(StackFrame stackFrame) {
        if (stackFrame instanceof AARCH64JVMSFrame) {
            final AARCH64JVMSFrame jvmsStackFrame = (AARCH64JVMSFrame) stackFrame;
