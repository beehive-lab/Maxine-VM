 ...
 * questions.
 */
package com.sun.max.vm.stack.aarch64;
...
/**
 * Describes a stack frame for a AARCH64 method whose frame conforms with the JVMS.
 ...
 */
public class AARCH64JVMSFrameLayout extends JVMSFrameLayout {
    ...
    public AARCH64JVMSFrameLayout(ClassMethodActor classMethodActor, int numberOfTemplateSlots) {
        super(classMethodActor);
        this.numberOfTemplateSlots = numberOfTemplateSlots;
    }

    public AARCH64JVMSFrameLayout(int numberOfLocalSlots, int numberOfOperandStackSlots, int numberOfParameterSlots, int numberOfTemplateSlots) {
