 ...
 * @author Michael Van De Vanter
  */
public final class JavaStackFrameViewPreferences extends TableColumnVisibilityPreferences<JavaStackFrameColumnKind> {

    private static JavaStackFrameViewPreferences globalPreferences;

    /**
     * @return the global, persistent set of user preferences for viewing a table describing a StackFrame.
     */
    static JavaStackFrameViewPreferences globalPreferences(Inspection inspection) {
        if (globalPreferences == null) {
            globalPreferences = new JavaStackFrameViewPreferences(inspection);
        }
     ...
     */
    private JavaStackFrameViewPreferences(Inspection inspection) {
        super(inspection, STACK_FRAME_COLUMN_PREFERENCE, JavaStackFrameColumnKind.VALUES);
