 ...
 * Company, Ltd.
 */
/*VCSID=e67d4eb6-8f9c-450b-a256-b0dd9444d8cd*/
/*
...
/**
 * Renders {@link TeleVM} memory contents as a list of words.
 *
 * @author Ben L. Titzer
...
public final class MemoryWordInspector extends Inspector {
    ...
    private final class RegisterAddressLabel extends WordValueLabel {
        ...
        RegisterAddressLabel(Inspection inspection, int line, Address address) {
            super(inspection, WordValueLabel.ValueMode.WORD, address.asWord());
            _line = line;
            updateText();
        }
