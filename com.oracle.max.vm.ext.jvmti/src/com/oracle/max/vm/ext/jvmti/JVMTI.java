...
import com.oracle.max.vm.ext.jvmti.JVMTIBreakpoints.EventBreakpointID;
import com.oracle.max.vm.ext.jvmti.JVMTIException.ExceptionEventData;
import com.oracle.max.vm.ext.jvmti.JVMTIThreadFunctions.FramePopEventData;
import com.oracle.max.vm.ext.jvmti.JVMTIUtil.ModeUnion;
import com.oracle.max.vm.ext.t1x.T1X;
import com.oracle.max.vm.ext.jvmti.t1x.JVMTI_T1XCompilationFactory;
import com.oracle.max.vm.ext.jvmti.t1x.JVMTI_T1XTemplateSource;
...
import static com.oracle.max.vm.ext.jvmti.JVMTICallbacks.*;
import static com.oracle.max.vm.ext.jvmti.JVMTIConstants.*;
import static com.oracle.max.vm.ext.jvmti.JVMTIEnvNativeStruct.CALLBACKS;
import static com.oracle.max.vm.ext.jvmti.JVMTIEvents.E;
import static com.oracle.max.vm.ext.jvmti.JVMTIEvents.JVMTIEventLogger;
import static com.oracle.max.vm.ext.jvmti.JVMTIFieldWatch.FieldEventData;
import static com.oracle.max.vm.ext.jvmti.JVMTIFieldWatch.invokeFieldAccessCallback;
