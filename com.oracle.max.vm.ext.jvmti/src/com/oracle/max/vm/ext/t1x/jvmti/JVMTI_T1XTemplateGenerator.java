...
public class JVMTI_T1XTemplateGenerator extends T1XTemplateGenerator {
    ...
    private void generateReturn(String k) {
        out.printf("        JVMTIThreadFunctions.framePopEvent(false%s);%n", k.equals("void") ? "" : ", value");
    }
    ...
    static boolean generate(boolean checkOnly, Class target) throws Exception {
        File base = new File(JavaProject.findWorkspace(), "com.oracle.max.vm.ext.jvmti/src");
