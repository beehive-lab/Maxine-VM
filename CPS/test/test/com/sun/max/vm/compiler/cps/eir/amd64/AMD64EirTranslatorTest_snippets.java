 ...
 */
public class AMD64EirTranslatorTest_snippets extends CompilerTestCase {

    public static void main(String[] args) {
        junit.textui.TestRunner.run(AMD64EirTranslatorTest_snippets.suite());
    }
    ...
    public AMD64EirTranslatorTest_snippets(String name) {
        super(name);
    }
