...
public class SPARCEirTranslatorTest_neg extends BytecodeTest_neg {
    ...
    public SPARCEirTranslatorTest_neg(String name) {
        super(name);
    }

    public static void main(String[] args) {
        junit.textui.TestRunner.run(SPARCEirTranslatorTest_neg.suite());
    }
