...
public class CirTranslatorTest_reflection extends CompilerTest_reflection<CirMethod> {

    public static void main(String[] args) {
        junit.textui.TestRunner.run(CirTranslatorTest_reflection.suite());
    }
    ...
    public CirTranslatorTest_reflection(String name) {
        super(name);
    }
