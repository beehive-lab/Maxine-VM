...
public class SPARCEirTranslatorTest_switch extends BytecodeTest_switch {
    ...
    public SPARCEirTranslatorTest_switch(String name) {
        super(name);
    }

    public static void main(String[] args) {
        junit.textui.TestRunner.run(SPARCEirTranslatorTest_switch.suite());
    }
