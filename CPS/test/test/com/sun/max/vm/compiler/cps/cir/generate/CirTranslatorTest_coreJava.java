 ...
 */
public class CirTranslatorTest_coreJava extends CompilerTest_coreJava {

    public static void main(String[] args) {
        junit.textui.TestRunner.run(CirTranslatorTest_coreJava.suite());
    }
    ...
    public CirTranslatorTest_coreJava(String name) {
        super(name);
    }
