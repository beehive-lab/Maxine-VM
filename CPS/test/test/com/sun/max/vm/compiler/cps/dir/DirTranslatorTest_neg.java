...
public class DirTranslatorTest_neg extends BytecodeTest_neg {
    ...
    public DirTranslatorTest_neg(String name) {
        super(name);
    }

    public static void main(String[] args) {
        junit.textui.TestRunner.run(DirTranslatorTest_neg.suite());
    }
