...
public class CirOptimizerTest_store extends BytecodeTest_store<CirMethod> {
    ...
    public CirOptimizerTest_store(String name) {
        super(name);
    }

    public static void main(String[] args) {
        junit.textui.TestRunner.run(CirOptimizerTest_store.suite());
    }
