 ...
 * 
 */
public class DirTranslatorTest_stack extends BytecodeTest_stack {
    ...
    public DirTranslatorTest_stack(String name) {
        super(name);
    }

    public static void main(String[] args) {
        junit.textui.TestRunner.run(DirTranslatorTest_stack.suite());
    }
