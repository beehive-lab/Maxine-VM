 ...
 */
public class CirTranslatorTest_max extends CompilerTest_max {
    ...
    public CirTranslatorTest_max(String name) {
        super(name);
    }

    public static void main(String[] args) {
        junit.textui.TestRunner.run(CirTranslatorTest_max.suite());
    }
