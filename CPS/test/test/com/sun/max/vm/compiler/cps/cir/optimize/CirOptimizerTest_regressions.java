 ...
 */
public class CirOptimizerTest_regressions extends CompilerTest_regressions<CirMethod> {

    public static void main(String[] args) {
        junit.textui.TestRunner.run(CirOptimizerTest_regressions.suite());
    }
    ...
    public CirOptimizerTest_regressions(String name) {
        super(name);
    }
