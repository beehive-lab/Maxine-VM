...
public class CirTranslatorTest_arrayLoad extends BytecodeTest_arrayLoad<CirMethod> {
    ...
    public static void main(String[] args) {
        junit.textui.TestRunner.run(CirTranslatorTest_arrayLoad.suite());
    }

    public CirTranslatorTest_arrayLoad(String name) {
        super(name);
    }
