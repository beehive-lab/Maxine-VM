...
public class SPARCEirTranslatorTest_reflection extends CompilerTest_reflection<CirMethod> {

    public static void main(String[] args) {
        junit.textui.TestRunner.run(SPARCEirTranslatorTest_reflection.suite());
    }
    ...
    public SPARCEirTranslatorTest_reflection(String name) {
        super(name);
    }
