...
public class CirOptimizerTest_reflection extends CompilerTest_reflection<CirMethod> {

    public static void main(String[] args) {
        junit.textui.TestRunner.run(CirOptimizerTest_reflection.suite());
    }
    ...
    public CirOptimizerTest_reflection(String name) {
        super(name);
    }
