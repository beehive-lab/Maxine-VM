...
import com.sun.max.vm.compiler.cps.ir.interpreter.eir.amd64.*;
...
public class AMD64EirTranslatorTestSetup extends CompilerTestSetup<EirMethod> {
    ...
    protected VMConfiguration createVMConfiguration() {
        return VMConfigurations.createStandard(BuildLevel.DEBUG, Platform.host().constrainedByInstructionSet(InstructionSet.AMD64), new com.sun.max.vm.compiler.cps.b.c.d.e.amd64.Package());
    }
}
