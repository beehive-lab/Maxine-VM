...
public class DirTranslatorTest_if extends BytecodeTest_if {
    ...
    public DirTranslatorTest_if(String name) {
        super(name);
    }

    public static void main(String[] programArguments) {
        junit.textui.TestRunner.run(DirTranslatorTest_if.suite());
    }
