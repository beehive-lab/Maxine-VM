...
public class CirTranslatorTest_if extends BytecodeTest_if {
    ...
    public CirTranslatorTest_if(String name) {
        super(name);
    }

    public static void main(String[] programArguments) {
        junit.textui.TestRunner.run(CirTranslatorTest_if.suite());
    }
