...
public enum StopType {
    /**
     * A position corresponding to a direct call (e.g. target method is known at compile time).
     */
    DIRECT_CALL {
        @Override
    ...
    /**
     * A position corresponding to a register indirect call (e.g. late binding call, virtual/interface call).
     */
    INDIRECT_CALL {
        @Override
        public int stopPositionIndex(TargetMethod targetMethod, int n) {
