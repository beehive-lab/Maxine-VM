...
public class JavaFrameDescriptor<Slot_Type> extends BytecodeLocation {
     ...
     * @param bci the BCI of the frame
     ...
     */
    public JavaFrameDescriptor(JavaFrameDescriptor<Slot_Type> parent, ClassMethodActor classMethodActor, int bci, Slot_Type[] locals, Slot_Type[] stackSlots) {
        super(classMethodActor, bci);
    ...
    public final String toMultiLineString() {
        ...
        do {
            ...
            final int bci = javaFrameDescriptor.bci;
            s += " where: " + classMethodActor.toStackTraceElement(bci) + "@" + bci;
            s += "\nlocals:";
    ...
    public final String toString() {
        ...
        do {
            final ClassMethodActor classMethodActor = javaFrameDescriptor.classMethodActor;
            final int bci = javaFrameDescriptor.bci;
            s += String.format("<<%s@%s locals:[%s] stack:[%s]>>", classMethodActor.format("%h.%n(%s)", bci),
                            bci,
