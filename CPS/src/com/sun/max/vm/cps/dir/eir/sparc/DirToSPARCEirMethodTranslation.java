 ...
 * Company, Ltd.
 */
package com.sun.max.vm.cps.dir.eir.sparc;

import com.sun.max.vm.cps.b.c.d.e.sparc.*;
...
public final class DirToSPARCEirMethodTranslation extends DirToEirMethodTranslation {
    public static final SPARCEirRegisters.GeneralPurpose SAVED_SAFEPOINT_LATCH_LOCAL = SPARCEirRegisters.GeneralPurpose.L5;
    ...
    protected EirInstruction createTrampolineExit(EirBlock eirBlock, boolean isStaticTrampoline) {
        return new RET(eirBlock, isStaticTrampoline ? RET.FROM.STATIC_TRAMPOLINE : RET.FROM.DYNAMIC_TRAMPOLINE);
    }
