...
import com.sun.max.vm.classfile.constant.ResolvedMethodRefConstant;
...
import com.sun.max.vm.compiler.MethodState;
...
import com.sun.max.vm.heap.LinearAllocatorHeapRegion;
import com.sun.max.vm.jit.JitTargetMethod;
import com.sun.max.vm.tele.MaxineMessenger;
import com.sun.max.vm.tele.TeleClassInfo;
import com.sun.max.vm.tele.TeleHeapInfo;
...
public class TeleFields extends TeleVMHolder {
    ...
    public final TeleInstanceReferenceFieldAccess ChainedHashMapping$DefaultEntry_value = new TeleInstanceReferenceFieldAccess(ChainedHashMapping.DefaultEntry.class, "_value", Object.class);
    ...
    public final TeleStaticReferenceFieldAccess Heap_bootHeapRegion = new TeleStaticReferenceFieldAccess(Heap.class, "_bootHeapRegion", LinearAllocatorHeapRegion.class);
