...
public class TeleFields extends AbstractTeleVMHolder {
    ...
    public final TeleInstanceReferenceFieldAccess TargetMethod_directCallees = new TeleInstanceReferenceFieldAccess(TargetMethod.class, "directCallees", ClassMethodActor[].class);
    ...
    public final TeleStaticWordFieldAccess TeleHeapInfo_roots = new TeleStaticWordFieldAccess(InspectableHeapInfo.class, "roots");
