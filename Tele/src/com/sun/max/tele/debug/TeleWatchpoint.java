...
public abstract class TeleWatchpoint extends AbstractTeleVMHolder implements VMTriggerEventHandler, MaxWatchpoint {
    ...
    public final boolean setEnabledDuringGC(boolean enabledDuringGC) throws MaxVMBusyException, ProgramError {
        ...
        try {
            ...
            if (enabledDuringGC && watchpointManager.vm().isInGC() && !active) {
                setActive(true);
            }
            success = reset();
        }  finally {
    ...
    public final boolean handleTriggerEvent(TeleNativeThread teleNativeThread) {
        ...
        if (watchpointManager.vm().isInGC() && !settings.enabledDuringGC) {
    ...
    public static final class WatchpointManager extends AbstractTeleVMHolder implements MaxWatchpointManager {
         ...
         * @throws TooManyWatchpointsException
         */
        private TeleWatchpoint createSystemWatchpoint(String description, TeleFixedMemoryRegion memoryRegion, WatchpointSettings settings) throws TooManyWatchpointsException {
        ...
        private TeleWatchpoint addClientWatchpoint(TeleWatchpoint teleWatchpoint)  throws TooManyWatchpointsException, DuplicateWatchpointException {
            ...
            if (!vm().isInGC() || teleWatchpoint.settings.enabledDuringGC) {
