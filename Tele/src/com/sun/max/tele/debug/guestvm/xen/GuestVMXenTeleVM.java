 ...
 * Company, Ltd.
 */
/*VCSID=d41a9e4e-0f40-4aa8-9175-56e49726b39e*/
...
public class GuestVMXenTeleVM extends TeleVM {
    ...
    protected TeleProcess createTeleProcess(String[] commandLineArguments, int id) throws IOException {
        ...
        _domain = new GuestVMXenTeleDomain(this, bootImage().vmConfiguration().platform(), programFile(), commandLineArguments, id);
        return _domain;
    }
