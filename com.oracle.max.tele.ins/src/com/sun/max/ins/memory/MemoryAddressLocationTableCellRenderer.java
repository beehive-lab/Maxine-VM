 ...
 * a memory address with a tooltip specified as a byte offset from some origin.
 */
public final class MemoryAddressLocationTableCellRenderer extends InspectorTableCellRenderer {
    ...
    private final LocationLabel.AsAddressWithByteOffset label;
    private final InspectorLabel[] labels = new InspectorLabel[1];

    public MemoryAddressLocationTableCellRenderer(Inspection inspection, InspectorTable inspectorTable, InspectorMemoryTableModel tableModel) {
        super(inspection);
        this.inspectorTable = inspectorTable;
        this.tableModel = tableModel;
        this.label = new LocationLabel.AsAddressWithByteOffset(inspection);
