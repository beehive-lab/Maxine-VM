 ...
 * Persistent preferences for viewing memory regions that the VM has allocated from the OS.
  */
public final class CardTableViewPreferences extends TableColumnVisibilityPreferences<CardTableColumnKind> {

    private static CardTableViewPreferences globalPreferences;

    /**
     * @return the global, persistent set of user preferences for viewing a table of memory allocations.
     */
    public static CardTableViewPreferences globalPreferences(Inspection inspection) {
        if (globalPreferences == null) {
            globalPreferences = new CardTableViewPreferences(inspection);
        }
        return globalPreferences;
    }

    // Prefix for all persistent column preferences in view
    private static final String CARD_TABLE_COLUMN_PREFERENCE = "cardTableViewColumn";
    ...
    */
    private CardTableViewPreferences(Inspection inspection) {
        super(inspection, CARD_TABLE_COLUMN_PREFERENCE, CardTableColumnKind.values());
