 ...
 * {@link com.sun.max.asm.arm.example.ExampleARMAssemblerSpecification} interface from a random subset of the methods in {@link com.sun.max.asm.arm.complete.ARMRawAssembler} and
 * {@link com.sun.max.asm.arm.complete.ARMLabelAssembler}. Next, the class into which the assembler methods will be generated must be written.
 ...
 * </pre>
 * In this example, the {@link com.sun.max.asm.arm.example.ExampleARMAssembler} serves this purpose.
 * <p>
 * Lastly, the {@linkplain com.sun.max.asm.gen.risc.arm.ARMAssemblerGenerator ARM assembler generator}
