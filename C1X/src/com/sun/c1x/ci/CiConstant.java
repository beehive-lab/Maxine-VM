...
public class CiConstant {
    ...
    public static final CiConstant NULL_OBJECT = new CiConstant(BasicType.Object, null);
     ...
     */
    public CiConstant(BasicType type, Object value) {
        this.basicType = type;
        this.value = value;
    }
    ...
    public static CiConstant forDouble(double d) {
        return new CiConstant(BasicType.Double, d);
    }
    ...
    public static CiConstant forFloat(float f) {
        return new CiConstant(BasicType.Float, f);
    }
    ...
    public static CiConstant forLong(long i) {
        return new CiConstant(BasicType.Long, i);
    }
    ...
    public static CiConstant forInt(int i) {
        return new CiConstant(BasicType.Int, i);
    }
    ...
    public static CiConstant forByte(byte i) {
        return new CiConstant(BasicType.Byte, i);
    }
    ...
    public static CiConstant forBoolean(boolean i) {
        return new CiConstant(BasicType.Boolean, i);
    }
    ...
    public static CiConstant forChar(char i) {
        return new CiConstant(BasicType.Char, i);
    }
    ...
    public static CiConstant forShort(short i) {
        return new CiConstant(BasicType.Short, i);
    }
    ...
    public static CiConstant forJsr(int i) {
        return new CiConstant(BasicType.Jsr, i);
    }
    ...
    public static CiConstant forWord(Number i) {
        if (i instanceof Integer || i instanceof Long) {
            return new CiConstant(BasicType.Word, i); // only Integer and Long are allowed
        }
    ...
    public static CiConstant forObject(Object o) {
        ...
        return new CiConstant(BasicType.Object, o);
    }
