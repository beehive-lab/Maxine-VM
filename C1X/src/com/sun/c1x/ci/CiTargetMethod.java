...
public interface CiTargetMethod {
     ...
     */
    void setTargetCode(byte[] code, int size);
     ...
     * are references
     */
    void recordSafepoint(int codePosition, boolean[] registerMap, boolean[] stackMap);

    /**
     * Records a call to a runtime method in the code.
     * @param codePosition the position in the code array
     * @param runtimeCall the runtime method being called
     * @param stackMap the bitmap that indicates which stack locations
     */
    void recordRuntimeCall(int codePosition, CiRuntimeCall runtimeCall, boolean[] stackMap);
     ...
     * @param stackMap the bitmap that indicates which stack locations
     */
    void recordDirectCall(int codePosition, CiMethod method, boolean[] stackMap);
     ...
     * @param stackMap the bitmap that indicates which stack locations
     */
    void recordIndirectCall(int codePosition, CiMethod method, boolean[] stackMap);
