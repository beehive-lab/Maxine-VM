...
#    $MAX gate ${VEE_TEST_OPTIONS} -maxvm-configs=std -maxvm-config-alias=jit-c1x0x > $RESULTS_DIR/jit-c1x0x
    ...
    echo jit-c1x1x
    $MAX gate ${VEE_TEST_OPTIONS} -maxvm-configs=std -maxvm-config-alias=jit-c1x1x > $RESULTS_DIR/jit-c1x1x

    echo jit-c1x2
    $MAX gate ${VEE_TEST_OPTIONS} -maxvm-configs=std -maxvm-config-alias=jit-c1x2 > $RESULTS_DIR/jit-c1x2
    
    echo jit-c1x2x
    $MAX gate ${VEE_TEST_OPTIONS} -maxvm-configs=std -maxvm-config-alias=jit-c1x2x > $RESULTS_DIR/jit-c1x2x
...
#    $MAX gate ${VEE_TEST_OPTIONS} -maxvm-configs=std -maxvm-config-alias=opt-c1x0x > $RESULTS_DIR/opt-c1x0x
    ...
    echo opt-c1x1x
    $MAX gate ${VEE_TEST_OPTIONS} -maxvm-configs=std -maxvm-config-alias=opt-c1x1x > $RESULTS_DIR/opt-c1x1x

    echo opt-c1x2
    $MAX gate ${VEE_TEST_OPTIONS} -maxvm-configs=std -maxvm-config-alias=opt-c1x2 > $RESULTS_DIR/opt-c1x2

    echo opt-c1x2x
    $MAX gate ${VEE_TEST_OPTIONS} -maxvm-configs=std -maxvm-config-alias=opt-c1x2x > $RESULTS_DIR/opt-c1x2x
