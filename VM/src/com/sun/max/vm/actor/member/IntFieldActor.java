 ...
 * Company, Ltd.
 */
/*VCSID=e95922e4-a3cd-488b-9c6c-e17f573a507e*/
 ...
 */
public class IntFieldActor extends FieldActor<IntValue> {

    public IntFieldActor(Utf8Constant name, int flags) {
        super(Kind.INT,
              name,
              JavaTypeDescriptor.INT,
              flags);
    }

    @INLINE
    public final int readInt(Object object) {
        return TupleAccess.readInt(object, offset());
    }
