 ...
 * Company, Ltd.
 */
/*VCSID=19356b04-f1e1-4370-bb28-b8dae3a4b5b6*/
...
public class BootImageException extends Exception {
    ...
    public static void check(boolean condition, String message) throws BootImageException {
        if (!condition) {
            throw new BootImageException(message);
        }
    }
}
