 ...
 */
public final class HostedGripScheme extends AbstractVMScheme implements GripScheme {

    private final DataModel dataModel;
    private final WordWidth gripWidth;

    public HostedGripScheme(VMConfiguration vmConfiguration) {
    ...
    public Grip fromJava(Object object) {
        return new HostedGrip(object);
    }

    public Object toJava(Grip grip) {
        final HostedGrip prototypeGrip = (HostedGrip) grip;
