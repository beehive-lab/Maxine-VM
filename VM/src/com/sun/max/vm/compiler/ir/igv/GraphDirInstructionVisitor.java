 ...
 * Company, Ltd.
 */
/*VCSID=c4fce140-d800-48d5-ba55-caa27dcffd88*/
/*
 * Copyright (c) 2007 Sun Microsystems, Inc. All rights reserved.
 * 
...
class GraphDirInstructionVisitor extends DirAdapter {
    ...
    public void visitSafepoint(DirSafepoint dirSafepoint) {
        ...
        node.getProperties().setProperty("bci", Integer.toString(dirSafepoint.javaFrameDescriptor().bytecodeLocation().position()));
    }
}
