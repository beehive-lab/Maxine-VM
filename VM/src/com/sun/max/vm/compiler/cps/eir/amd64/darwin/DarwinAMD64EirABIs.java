 ...
 * Company, Ltd.
 */
package com.sun.max.vm.compiler.cps.eir.amd64.darwin;

import com.sun.max.annotate.*;
import com.sun.max.vm.*;
import com.sun.max.vm.compiler.cps.eir.amd64.*;
import com.sun.max.vm.compiler.cps.eir.amd64.unix.*;

/**
 * @author Bernd Mathiske
 */
public class DarwinAMD64EirABIs extends AMD64EirABIsScheme {

    @HOSTED_ONLY
    public DarwinAMD64EirABIs(VMConfiguration vmConfiguration) {
