...
public abstract class CPSTargetGenerator extends IrGenerator<RuntimeCompilerScheme, CPSTargetMethod> {
    ...
    public CPSTargetGenerator(RuntimeCompilerScheme dynamicCompilerScheme, InstructionSet instructionSet) {
