...
public final class SPARCSystemVTargetABIsScheme extends SPARCTargetABIsScheme {
    ...
    public SPARCSystemVTargetABIsScheme(VMConfiguration vmConfiguration) {
        super(vmConfiguration,
                        createSPARC64TargetABI(_javaJitRegisterRoleAssignment, CallEntryPoint.JIT_ENTRY_POINT, incomingIntegerParameterRegisters, outgoingIntegerParameterRegisters, floatingPointParameterRegisters, false, false),
