 ...
 * Company, Ltd.
 */
/*VCSID=91a76e9b-f85a-4d5f-beff-3650b9439617*/
 ...
 */
public final class IA32EirEpilogue extends EirEpilogue<IA32EirInstructionVisitor, IA32EirTargetEmitter> implements IA32EirInstruction {

    public IA32EirEpilogue(EirBlock block, EirMethod eirMethod,
    ...
    public void emit(IA32EirTargetEmitter emitter) {
        if (!eirMethod().isTemplate()) {
            ...
            if (frameSize != 0) {
                emitter.assembler().addl(emitter.framePointer(), frameSize);
            }
        }
    }
