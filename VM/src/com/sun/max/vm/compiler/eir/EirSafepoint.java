 ...
 * Company, Ltd.
 */
/*VCSID=36732ebc-5ae3-4bc8-94f9-98c6cb56da7a*/
 ...
 */
public abstract class EirSafepoint<EirInstructionVisitor_Type extends EirInstructionVisitor, EirTargetEmitter_Type extends EirTargetEmitter>
                      extends EirStop<EirInstructionVisitor_Type, EirTargetEmitter_Type> {

    public EirSafepoint(EirBlock block) {
        super(block);
    }
