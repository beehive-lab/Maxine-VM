 ...
 * Company, Ltd.
 */
/*VCSID=0d90c3d0-2990-47f0-9839-6f6e3143c6d2*/
...
public interface DynamicTrampolineScheme extends VMScheme {
    ...
    Address makeInterfaceCallEntryPoint(int iIndex);

    DynamicTrampolineExit dynamicTrampolineExit();
}
