 ...
 * Company, Ltd.
 */
/*VCSID=af670b11-ad55-456f-b0fd-2ee3bc63033d*/
...
public final class VmClassLoader extends ClassLoader {
    ...
    protected Class findClass(Classpath classpath, String name) throws ClassNotFoundException {
        ...
        return ClassfileReader.defineClassActor(name, this, classpathFile._contents, null, classpathFile._classpathEntry).toJava();
    }
