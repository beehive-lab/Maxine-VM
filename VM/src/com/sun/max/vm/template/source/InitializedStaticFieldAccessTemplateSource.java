...
public class InitializedStaticFieldAccessTemplateSource {
    ...
    public static void zgetstatic(Object staticTuple, int offset) {
        JitStackFrameOperation.pushInt(UnsafeLoophole.asByte(TupleAccess.readBoolean(staticTuple, offset)));
    }
    ...
    public static void zputstatic(Object staticTuple, int offset) {
        final boolean value = UnsafeLoophole.asBoolean((byte) JitStackFrameOperation.popInt());
