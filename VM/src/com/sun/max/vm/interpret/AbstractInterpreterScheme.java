...
/**
 * Base class for bytecode interpreter schemes.
 *
 * @author Simon Wilkinson
 */
public abstract class AbstractInterpreterScheme extends AbstractVMScheme implements InterpreterScheme {

    protected AbstractInterpreterScheme(VMConfiguration vmConfiguration) {
    ...
    public TargetMethod makeInterpretedTargetMethod(ClassMethodActor classMethodActor) {
        ...
        synchronized (methodState) {
            if (methodState.currentTargetMethod() == null) {
                targetMethodGenerator().generate(methodState);
            }
        }
