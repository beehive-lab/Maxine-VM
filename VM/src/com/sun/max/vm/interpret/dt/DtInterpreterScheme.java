...
/**
 * Scheme for template-based, direct-threaded (DT) style interpreters.
 * Subclasses should be architecture specific.
 *
...
public abstract class DtInterpreterScheme extends AbstractInterpreterScheme {
    ...
    /**
     * Runtime interpreter generation.
     */
    public abstract DtInterpreter generateInterpreter();
