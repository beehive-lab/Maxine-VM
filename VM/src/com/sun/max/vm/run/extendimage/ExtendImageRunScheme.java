...
public class ExtendImageRunScheme extends JavaRunScheme {
    ...
    protected void forceClass(String className, boolean isMain) {
        ...
        if (isMain) {
            ...
            try {
                final ClassActor mainClassActor = ClassActor.fromJava(Classes.load(PrototypeClassLoader.PROTOTYPE_CLASS_LOADER, className));
    ...
    protected void forceCompileMethod(String forceMethodName) {
        ...
        try {
            final ClassActor classActor = ClassActor.fromJava(Classes.load(PrototypeClassLoader.PROTOTYPE_CLASS_LOADER, className));
