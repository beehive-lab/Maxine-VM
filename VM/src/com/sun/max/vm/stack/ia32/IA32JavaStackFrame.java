 ...
 * Company, Ltd.
 */
/*VCSID=9a21f618-5892-49ad-83c3-fa51e050c7a5*/
 ...
 * @author Doug Simon
 */
public class IA32JavaStackFrame extends JavaStackFrame<OptoStackFrameLayout> {

    public IA32JavaStackFrame(StackFrame callee, TargetMethod targetMethod, Pointer instructionPointer, Pointer framePointer, Pointer stackPointer) {
    ...
    public boolean isSameFrame(StackFrame stackFrame) {
        if (stackFrame instanceof IA32JavaStackFrame) {
