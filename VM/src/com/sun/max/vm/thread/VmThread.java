...
public class VmThread {
    ...
    public static VmThread current() {
        ...
        return UnsafeLoophole.asVmThread(VM_THREAD.getConstantReference().toJava());
    }
    ...
    public static VmThread fromVmThreadLocals(Pointer vmThreadLocals) {
        ...
        return UnsafeLoophole.asVmThread(VM_THREAD.getConstantReference(vmThreadLocals).toJava());
    }
