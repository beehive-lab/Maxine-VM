 ...
 * Company, Ltd.
 */
/*VCSID=ccd15436-737e-4fb0-af96-a5dd81ee1cca*/
...
public final class BeltManager {
    ...
    private void initializeFirstBelt() {
        ...
        _belts.get(0).setStartAddress(HeapSchemeConfiguration.getApplicationHeapStartAddress());
    ...
    private Size calculateBeltSize(int i) {
        final Size heapSize = HeapSchemeConfiguration.getMaxHeapSize();
        final Size beltSize = heapSize.times(BeltwayConfiguration.getPercentOfUsableMemoryPerBelt(i)).dividedBy(100);
        return beltSize.roundedUpBy(HeapSchemeConfiguration.TLAB_SIZE.toInt()).asSize();
    }
