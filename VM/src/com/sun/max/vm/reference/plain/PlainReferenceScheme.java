 ...
 * Company, Ltd.
 */
/*VCSID=4c2a2a81-b3ce-40d2-97ea-2f0befa7afa2*/
package com.sun.max.vm.reference.plain;
 ...
 */
public final class PlainReferenceScheme extends AbstractVMScheme implements ReferenceScheme {

    public PlainReferenceScheme(VMConfiguration vmConfiguration) {
    ...
    public Reference fromGrip(Grip grip) {
        return UnsafeLoophole.gripToReference(grip);
    }
