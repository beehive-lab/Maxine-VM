 ...
 * Company, Ltd.
 */
/*VCSID=925592c7-9179-4bea-8ecf-fbc434126c59*/
...
public enum Bytecode implements BytecodeInfo {
     ...
     * </ol>
     * In addition, the following epilogue must be performed immediately after returning from the call:
     * <ol>
     * <li>A {@linkplain Safepoint#hard() hard safepoint} must be executed.
     * <li>The thread must be put in a state that denotes it is now executing in Java code.
     * </ol>
     */
