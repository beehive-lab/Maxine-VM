 ...
 * return type is the type being converted to.
 *
 * The compiler translates calls to these methods to simply replace the use of the result with the single parameter. In
