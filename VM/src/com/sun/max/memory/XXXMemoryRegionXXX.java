 ...
 */
public interface XXXMemoryRegionXXX {
     ...
     */
    boolean overlaps(XXXMemoryRegionXXX memoryRegion);

    /**
     * @return does the region have the same bounds as another region.
     * @see Util#equal(XXXMemoryRegionXXX, XXXMemoryRegionXXX)
     */
    boolean sameAs(XXXMemoryRegionXXX memoryRegion);
    ...
    public static class Util {
        /**
         * Gets a string representation for a memory region composed of its {@linkplain XXXMemoryRegionXXX#regionName() description}
         * and {@linkplain XXXMemoryRegionXXX#start()} - {@linkplain XXXMemoryRegionXXX#end()} address range.
         */
        public static String asString(XXXMemoryRegionXXX memoryRegion) {
        ...
        public static boolean equal(RuntimeMemoryRegion left, RuntimeMemoryRegion right) {
            if (left == null) {
                return right == null;
            }
            if (right == null) {
