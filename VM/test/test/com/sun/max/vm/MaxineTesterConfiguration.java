...
public class MaxineTesterConfiguration {
    ...
    static final Object[] _javaTestList = {
        test.bytecode.BC_frem.class,                   FAIL_SPARC,
        test.except.Catch_NPE_03.class,                FAIL_SPARC,
        test.except.Catch_NPE_04.class,                FAIL_SPARC,
        test.except.Catch_NPE_06.class,                FAIL_SPARC,
        test.lang.ClassLoader_loadClass01.class,       FAIL_SPARC,
        test.lang.Class_asSubclass01.class,            FAIL_SPARC,
        test.lang.Class_cast01.class,                  FAIL_SPARC,
        test.lang.Class_forName01.class,               FAIL_SPARC,
        test.lang.Class_forName02.class,               FAIL_SPARC,
        test.lang.Class_forName03.class,               FAIL_SPARC,
        test.lang.Class_forName04.class,               FAIL_SPARC,
        test.lang.Object_clone01.class,                FAIL_SPARC,
        test.lang.Object_notify01.class,               FAIL_SPARC,
        test.lang.Object_notifyAll01.class,            FAIL_SPARC,
        test.lang.Object_wait01.class,                 FAIL_SPARC,
        test.output.Thread_join04.class,               FAIL_SPARC,
        test.reflect.Array_get01.class,                FAIL_SPARC,
        test.reflect.Array_get02.class,                FAIL_SPARC,
        test.reflect.Array_get03.class,                FAIL_SPARC,
        test.reflect.Array_getBoolean01.class,         FAIL_SPARC,
