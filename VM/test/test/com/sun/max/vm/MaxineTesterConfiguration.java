...
public class MaxineTesterConfiguration {
    ...
    static {
        ...
        jtt(jtt.bytecode.BC_idiv2.class,                  RAND_ALL); // incorrect code generated by CPS compiler, C1X passes
        jtt(jtt.bytecode.BC_irem2.class,                  RAND_ALL); // incorrect code generated by CPS compiler, C1X passes
        jtt(jtt.bytecode.BC_ldiv2.class,                  RAND_ALL); // incorrect code generated by CPS compiler, C1X passes
        jtt(jtt.bytecode.BC_lrem2.class,                  RAND_ALL); // incorrect code generated by CPS compiler, C1X passes
