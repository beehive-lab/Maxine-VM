 ...
 * Company, Ltd.
 */
/*VCSID=cd8b56ec-0a43-476e-9136-302384257b53*/
...
/**
 * Runs unit test JITTest_tableWithResolvedFieldAccessTemplate for SPARC.
 * @see JITTest_tableWithResolvedFieldAccessTemplate
 * @author Laurent Daynes
 */
@org.junit.runner.RunWith(org.junit.runners.AllTests.class)
public class SPARCJITTest_tableWithResolvedFieldAccessTemplate extends JITTest_tableWithResolvedFieldAccessTemplate {

    public static void main(String[] args) {
        junit.textui.TestRunner.run(SPARCJITTest_tableWithResolvedFieldAccessTemplate.suite());
    }
