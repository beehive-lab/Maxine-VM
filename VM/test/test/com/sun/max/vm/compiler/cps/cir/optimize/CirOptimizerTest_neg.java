...
public class CirOptimizerTest_neg extends BytecodeTest_neg {
    ...
    public CirOptimizerTest_neg(String name) {
        super(name);
    }

    public static void main(String[] args) {
        junit.textui.TestRunner.run(CirOptimizerTest_neg.suite());
    }
