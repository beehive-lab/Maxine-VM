 ...
 * Company, Ltd.
 */
/*VCSID=1dd5e08f-7d7e-4e23-a538-9b6fcd75358a*/
...
public class AMD64TranslatorTest_referencedMethod extends CompilerTestCase<TargetMethod> {
    ...
    public static Test suite() {
        final TestSuite suite = new TestSuite(AMD64TranslatorTest_referencedMethod.class.getSimpleName());
        //$JUnit-BEGIN$
        suite.addTestSuite(AMD64TranslatorTest_referencedMethod.class);
        //$JUnit-END$
