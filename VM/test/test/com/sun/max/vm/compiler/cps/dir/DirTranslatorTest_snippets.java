 ...
 */
public class DirTranslatorTest_snippets extends CompilerTestCase {

    public static void main(String[] args) {
        junit.textui.TestRunner.run(DirTranslatorTest_snippets.suite());
    }
    ...
    public DirTranslatorTest_snippets(String name) {
        super(name);
    }
