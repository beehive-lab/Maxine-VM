 ...
 */
public class DirTranslatorTest_strengthReduction extends CompilerTest_strengthReduction<CirMethod> {
    ...
    public DirTranslatorTest_strengthReduction(String name) {
        super(name);
    }

    public static void main(String[] args) {
        junit.textui.TestRunner.run(DirTranslatorTest_strengthReduction.suite());
    }
