 ...
 */
public class CirOptimizerTest_max extends CompilerTest_max {

    public static void main(String[] args) {
        junit.textui.TestRunner.run(CirOptimizerTest_max.suite());
    }
    ...
    public CirOptimizerTest_max(String name) {
        super(name);
    }
