...
public class SPARCEirTranslatorTest_binaryArithmetic extends BytecodeTest_binaryArithmetic {
    public static Test suite() {
        ...
        suite.addTestSuite(SPARCEirTranslatorTest_binaryArithmetic.class);
        return new SPARCEirTranslatorTestSetup(suite);
    }

    public SPARCEirTranslatorTest_binaryArithmetic(String name) {
        super(name);
    }

    public static void main(String[] args) {
        junit.textui.TestRunner.run(SPARCEirTranslatorTest_binaryArithmetic.suite());
    }
