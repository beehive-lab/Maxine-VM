 ...
 */
public class DirTranslatorTest_jdk_System extends JdkTest_System<CirMethod> {
    ...
    public static void main(String[] args) {
        junit.textui.TestRunner.run(DirTranslatorTest_jdk_System.suite());
    }

    public DirTranslatorTest_jdk_System(String name) {
        super(name);
    }
