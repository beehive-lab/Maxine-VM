...
public class SPARCEirTranslatorTest_ifcmp extends BytecodeTest_ifcmp {
    ...
    public SPARCEirTranslatorTest_ifcmp(String name) {
        super(name);
    }

    public static void main(String[] args) {
        junit.textui.TestRunner.run(SPARCEirTranslatorTest_ifcmp.suite());
    }
