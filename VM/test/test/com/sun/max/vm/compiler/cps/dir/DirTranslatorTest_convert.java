...
public class DirTranslatorTest_convert extends BytecodeTest_convert {
    ...
    public DirTranslatorTest_convert(String name) {
        super(name);
    }

    public static void main(String[] args) {
        junit.textui.TestRunner.run(DirTranslatorTest_convert.suite());
    }
