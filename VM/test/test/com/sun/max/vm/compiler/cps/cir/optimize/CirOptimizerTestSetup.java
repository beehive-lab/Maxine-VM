...
import test.com.sun.max.vm.compiler.cps.cir.*;
...
public class CirOptimizerTestSetup extends CirCompilerTestSetup {
    ...
    public CirOptimizerTestSetup(Test test) {
        super(test);
    }

    @Override
    protected IrInterpreter<CirMethod> createInterpreter() {
    ...
    protected VMConfiguration createVMConfiguration() {
        return VMConfigurations.createStandard(BuildLevel.DEBUG, Platform.host(),
                                     new com.sun.max.vm.compiler.cps.b.c.Package());
    }
}
