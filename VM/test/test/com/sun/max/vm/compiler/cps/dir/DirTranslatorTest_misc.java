...
public class DirTranslatorTest_misc extends BytecodeTest_misc {

    public static void main(String[] args) {
        junit.textui.TestRunner.run(DirTranslatorTest_misc.suite());
    }
    ...
    public DirTranslatorTest_misc(String name) {
        super(name);
    }
