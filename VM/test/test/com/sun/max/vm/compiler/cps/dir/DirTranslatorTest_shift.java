...
public class DirTranslatorTest_shift extends BytecodeTest_shift {
    ...
    public DirTranslatorTest_shift(String name) {
        super(name);
    }

    public static void main(String[] args) {
        junit.textui.TestRunner.run(DirTranslatorTest_shift.suite());
    }
