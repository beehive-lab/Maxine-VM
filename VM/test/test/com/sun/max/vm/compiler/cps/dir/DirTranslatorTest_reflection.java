 ...
 */
public class DirTranslatorTest_reflection extends CompilerTest_reflection<CirMethod> {

    public static void main(String[] args) {
        junit.textui.TestRunner.run(DirTranslatorTest_reflection.suite());
    }
    ...
    public DirTranslatorTest_reflection(String name) {
        super(name);
    }
