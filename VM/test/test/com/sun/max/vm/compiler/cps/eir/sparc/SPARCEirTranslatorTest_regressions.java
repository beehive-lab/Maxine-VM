 ...
 */
public class SPARCEirTranslatorTest_regressions extends CompilerTest_regressions<CirMethod> {

    public static void main(String[] args) {
        junit.textui.TestRunner.run(SPARCEirTranslatorTest_regressions.suite());
    }
    ...
    public SPARCEirTranslatorTest_regressions(String name) {
        super(name);
    }
