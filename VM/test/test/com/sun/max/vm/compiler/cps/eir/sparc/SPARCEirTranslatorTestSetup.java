...
import com.sun.max.vm.compiler.cps.ir.interpreter.eir.sparc.*;
...
public class SPARCEirTranslatorTestSetup extends CompilerTestSetup<EirMethod> {
    ...
    protected VMConfiguration createVMConfiguration() {
        return VMConfigurations.createStandard(BuildLevel.DEBUG, Platform.host().constrainedByInstructionSet(InstructionSet.SPARC), new com.sun.max.vm.compiler.cps.b.c.d.e.sparc.Package());
    }
