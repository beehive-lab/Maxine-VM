...
public class DirTranslatorTest_ifcmp extends BytecodeTest_ifcmp {
    ...
    public DirTranslatorTest_ifcmp(String name) {
        super(name);
    }

    public static void main(String[] args) {
        junit.textui.TestRunner.run(DirTranslatorTest_ifcmp.suite());
    }
