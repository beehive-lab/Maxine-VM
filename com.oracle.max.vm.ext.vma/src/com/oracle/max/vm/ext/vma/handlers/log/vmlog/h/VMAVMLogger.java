 ...
 * Since the {@link VMAdviceHandlerLog} does not explicitly pass time, but uses a callback (for historical reasons
 * related to synchronous logging), we store the time in a field and implement
 * {@link VMAdviceHandlerLog.TimeStampGenerator} directly. This obviously requires that concurrent threads are not
 * interleaving their flushing; it turns out that the file format requires this property anyway, and we assume that this
 * is taken care of by our caller by an appropriate lock.
 */
...
// EDIT AND RUN VMAVMLoggerGenerator.main() TO MODIFY
        ...
        protected void traceAdviseBeforeThreadStarting(long arg1, VmThread arg2) {
            timeStamp = arg1;
            handler.adviseBeforeThreadStarting(arg2);
        }
        @Override
        ...
        protected void traceAdviseBeforeArrayStore(long arg1, Object arg2, int arg3, float arg4) {
            timeStamp = arg1;
            handler.adviseBeforeArrayStore(arg2, arg3, arg4);
        }
        @Override
        ...
        protected void traceAdviseBeforeStackAdjust(long arg1, int arg2) {
            timeStamp = arg1;
            handler.adviseBeforeStackAdjust(arg2);
        }
        @Override
        protected void traceAdviseBeforeOperation(long arg1, int arg2, long arg3, long arg4) {
            timeStamp = arg1;
            handler.adviseBeforeOperation(arg2, arg3, arg4);
        }
        @Override
        ...
        protected void traceAdviseBeforeConversion(long arg1, int arg2, float arg3) {
            timeStamp = arg1;
            handler.adviseBeforeConversion(arg2, arg3);
        }
        @Override
        ...
        protected void traceAdviseBeforeIf(long arg1, int arg2, int arg3, int arg4) {
            timeStamp = arg1;
            handler.adviseBeforeIf(arg2, arg3, arg4);
        }
        @Override
        ...
        protected void traceAdviseBeforeBytecode(long arg1, int arg2) {
            timeStamp = arg1;
            handler.adviseBeforeBytecode(arg2);
        }
        @Override
        ...
        protected void traceAdviseBeforeReturn(long arg1, long arg2) {
            timeStamp = arg1;
            handler.adviseBeforeReturn(arg2);
        }
        @Override
