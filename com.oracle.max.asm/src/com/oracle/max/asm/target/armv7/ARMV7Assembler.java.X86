...
//            disp += targetMethod.frameSize() + 8;
     ...
     * The selection is done in {@link ARMV7MacroAssembler#movdbl(CiRegister, CiAddress)}
     * and {@link ARMV7MacroAssembler#movflt(CiRegister, CiRegister)}.
     */
    ...
    public void nullCheck(CiRegister r) {
        testl(ARMV7.rax, new CiAddress(Word, r.asValue(Word), 0));
    }
