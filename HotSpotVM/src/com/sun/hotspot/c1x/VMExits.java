...
public class VMExits {
    ...
    public static void compileMethod(RiMethod method, int entryBci) {

        // This assertion is necessary and a potential life saver as this method is called from the VM
        assert method instanceof RiMethod : "Corrupt call from VM; expected instance of RiMethod, received " + method.getClass().getName();
