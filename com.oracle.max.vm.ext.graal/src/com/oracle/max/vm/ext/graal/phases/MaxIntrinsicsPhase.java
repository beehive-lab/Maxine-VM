...
public class MaxIntrinsicsPhase extends Phase {
    ...
    private void intrinsify(Invoke invoke, MaxResolvedJavaMethod method) {
        ...
        if (impl != null) {
            ...
            if (graph instanceof ValueNode) {
                ...
                StructuredGraph inlineGraph = (StructuredGraph) graph;
