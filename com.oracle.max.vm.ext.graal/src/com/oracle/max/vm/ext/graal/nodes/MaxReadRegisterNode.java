...
public final class MaxReadRegisterNode extends FixedWithNextNode implements LIRLowerable {

    private final Register register;

    public MaxReadRegisterNode(Register register, ResolvedJavaType javaType) {
        super(StampFactory.declared(javaType, false));
        this.register = register;
    }

    public MaxReadRegisterNode(Register register) {
