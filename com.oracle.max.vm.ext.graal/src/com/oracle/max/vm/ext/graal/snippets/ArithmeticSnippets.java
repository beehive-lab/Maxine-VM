...
public final class ArithmeticSnippets extends SnippetLowerings implements SnippetsInterface {
    ...
    public static void registerLowerings(VMConfiguration config, TargetDescription targetDescription, MetaAccessProvider runtime,
        ...
        new ArithmeticSnippets(config, targetDescription, runtime, assumptions, lowerings);
    }

    private ArithmeticSnippets(VMConfiguration vmConfiguration, TargetDescription targetDescription, MetaAccessProvider runtime, Assumptions assumptions, Map<Class< ? extends Node>, LoweringProvider> lowerings) {
