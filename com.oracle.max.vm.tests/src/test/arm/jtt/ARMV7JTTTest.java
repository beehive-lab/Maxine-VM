...
public class ARMV7JTTTest extends MaxTestCase {
    ...
    private Object[] generateObjectsAndTestStubs(String functionPrototype, int entryPoint, byte[] theCode, int[] expected, boolean[] tests, MaxineARMTester.BitsFlag[] masks)
                    throws Exception {
    ...
    private int[] generateAndTestStubs(String functionPrototype, int entryPoint, byte[] theCode, int[] expected, boolean[] tests, MaxineARMTester.BitsFlag[] masks)
                    throws Exception {
        ARMCodeWriter code = new ARMCodeWriter(theCode);
        code.createStaticCodeStubsFile(functionPrototype, theCode, entryPoint);
        MaxineARMTester r = new MaxineARMTester(expected, tests, masks);
    ...
    public void ignore_T1X_jtt_UsageOfStaticMethods() throws Exception {
        initTests();
    ...
    public void ignore_T1X_jtt_BC_imul() throws Exception {
        initTests();
        MaxineByteCode xx = new MaxineByteCode();
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturnUnlock");
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturn");
    ...
    public void ignore_T1X_jtt_BC_isub() throws Exception {
        initTests();
        MaxineByteCode xx = new MaxineByteCode();
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturnUnlock");
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturn");
    ...
    public void ignore_T1X_jtt_BC_ineg() throws Exception {
        initTests();
        MaxineByteCode xx = new MaxineByteCode();
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturnUnlock");
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturn");
    ...
    public void ignore_T1X_jtt_BC_ineg_1() throws Exception {
        initTests();
        MaxineByteCode xx = new MaxineByteCode();
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturnUnlock");
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturn");
    ...
    public void ignore_T1X_jtt_BC_iadd() throws Exception {
        initTests();
        MaxineByteCode xx = new MaxineByteCode();
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturnUnlock");
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturn");
        ...
        masm.mov32BitConstant(ARMV7.r1, -49);
        masm.push(ConditionFlag.Always, 1);
        masm.push(ConditionFlag.Always, 2);
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "iadd");
        theCompiler.offlineT1XCompile(anMethod, codeAttr, code, code.length - 1);
    ...
    public void ignore_T1X_jtt_BC_ior() throws Exception {
        initTests();
        MaxineByteCode xx = new MaxineByteCode();
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturnUnlock");
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturn");
    ...
    public void ignore_T1X_jtt_BC_ixor() throws Exception {
        initTests();
        MaxineByteCode xx = new MaxineByteCode();
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturnUnlock");
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturn");
    ...
    public void ignore_T1X_jtt_BC_ishl() throws Exception {
        initTests();
        MaxineByteCode xx = new MaxineByteCode();
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturnUnlock");
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturn");
    ...
    public void work_C1X_jtt_BC_ishl() throws Exception {
        CompilationBroker.OFFLINE = initialised;
    ...
    public void work_C1X_jtt_BC_ishr() throws Exception {
        CompilationBroker.OFFLINE = initialised;
    ...
    public void work_C1X_jtt_BC_iushr() throws Exception {
        CompilationBroker.OFFLINE = initialised;
    ...
    public void ignore_T1X_jtt_BC_ishr() throws Exception {
        initTests();
        MaxineByteCode xx = new MaxineByteCode();
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturnUnlock");
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturn");
    ...
    public void ignore_T1X_jtt_BC_ishr_1() throws Exception {
        initTests();
        MaxineByteCode xx = new MaxineByteCode();
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturnUnlock");
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturn");
    ...
    public void ignore_T1X_jtt_BC_iushr() throws Exception {
        initTests();
        MaxineByteCode xx = new MaxineByteCode();
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturnUnlock");
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturn");
    ...
    public void ignore_T1X_jtt_BC_i2b_1() throws Exception {
        initTests();
        MaxineByteCode xx = new MaxineByteCode();
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturnUnlock");
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturn");
    ...
    public void ignore_T1X_jtt_BC_i2b_2() throws Exception {
        initTests();
        MaxineByteCode xx = new MaxineByteCode();
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturnUnlock");
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturn");
    ...
    public void ignore_T1X_jtt_BC_i2s() throws Exception {
        initTests();
        MaxineByteCode xx = new MaxineByteCode();
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturnUnlock");
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturn");
    ...
    public void ignore_T1X_jtt_BC_i2s_1() throws Exception {
        initTests();
        MaxineByteCode xx = new MaxineByteCode();
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturnUnlock");
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturn");
    ...
    public void ignore_T1X_jtt_BC_i2s_2() throws Exception {
        initTests();
        MaxineByteCode xx = new MaxineByteCode();
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturnUnlock");
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturn");
    ...
    public void ignore_T1X_jtt_BC_i2c() throws Exception {
        initTests();
        MaxineByteCode xx = new MaxineByteCode();
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturnUnlock");
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturn");
    ...
    public void ignore_T1X_jtt_BC_i2c_1() throws Exception {
        initTests();
        MaxineByteCode xx = new MaxineByteCode();
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturnUnlock");
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturn");
    ...
    public void test2_T1X_jtt_BC_ireturn() throws Exception {
        initTests();
        MaxineByteCode xx = new MaxineByteCode();
        t1x.createOfflineTemplate(c1x, T1XTemplateSource.class, t1x.templates, "ireturnUnlock");
    ...
    public void ignore_C1X_jtt_BC_lookupswitch01() throws Exception {
        initTests();
        CompilationBroker.OFFLINE = initialised;
    ...
    public void ignore_C1X_jtt_BC_lookupswitch02() throws Exception {
        initTests();
        CompilationBroker.OFFLINE = initialised;
    ...
    public void ignore_C1X_jtt_BC_lookupswitch03() throws Exception {
        initTests();
        CompilationBroker.OFFLINE = initialised;
        int argOne[] = { 0, 1, 44, 66, 67, 68, 96, 97, 98, 106, 107, 108, 132, 133, 134, 211, 212, 213, -121, -122, -123};
    ...
    public void ignore_C1X_jtt_BC_lookupswitch04() throws Exception {
        initTests();
        CompilationBroker.OFFLINE = initialised;
        int argOne[] = { 0, 1, 44, 66, 67, 68, 96, 97, 98, 106, 107, 108, 132, 133, 134, 211, 212, 213, -121, -122, -123};
    ...
    public void ignore_C1X_jtt_BC_tableswitch2() throws Exception {
        initTests();
        CompilationBroker.OFFLINE = initialised;
         int argOne[] = { 7, -1, 0, 1, 2, 3, 4, 5, 6, 0};
    ...
    public void ignore_C1X_jtt_BC_tableswitch3() throws Exception {
        initTests();
        CompilationBroker.OFFLINE = initialised;
    ...
    public void ignore_C1X_jtt_BC_tableswitch4() throws Exception {
        initTests();
        CompilationBroker.OFFLINE = initialised;
    ...
    public void ignore_T1X_jtt_BC_tableswitch() throws Exception {
        initTests();
        List<Args> pairs = new LinkedList<Args>();
    ...
    public void ignore_T1X_jtt_BC_tableswitch_2() throws Exception {
        initTests();
        List<Args> pairs = new LinkedList<Args>();
    ...
    public void ignore_T1X_jtt_BC_XXXXfdiv() throws Exception {
        ...
        for (int i = 0; i < argOne.length; i++) {
            ...
            masm.vpush(ConditionFlag.Always, ARMV7.s0, ARMV7.s1, CiKind.Float, CiKind.Float);
            ...
            assert (((Float) registerValues[33]).floatValue() == answer) : " FDIV T1X " + ((Float) registerValues[33]).floatValue();
        }
    }

    public void ignore_T1X_jtt_BC_tableswitch_3() throws Exception {
        initTests();
        List<Args> pairs = new LinkedList<Args>();
        pairs.add(new Args(-1, 11));
    ...
    public void ignore_T1X_jtt_BC_tableswitch_4() throws Exception {
        initTests();
        List<Args> pairs = new LinkedList<Args>();
        pairs.add(new Args(-1, 11));
        pairs.add(new Args(0, 11));
    ...
    public void ignore_T1X_jtt_BC_lookupswitch_1() throws Exception {
        initTests();
        List<Args> pairs = new LinkedList<Args>();
    ...
    public void ignore_T1X_jtt_BC_lookupswitch_2() throws Exception {
        initTests();
        List<Args> pairs = new LinkedList<Args>();
        pairs.add(new Args(0, 42));
        pairs.add(new Args(1, 42));
    ...
    public void ignore_T1X_jtt_BC_lookupswitch_3() throws Exception {
        initTests();
        List<Args> pairs = new LinkedList<Args>();
        pairs.add(new Args(0, 42));
        pairs.add(new Args(1, 42));
    ...
    public void ignore_T1X_jtt_BC_lookupswitch_4() throws Exception {
        initTests();
        List<Args> pairs = new LinkedList<Args>();
        pairs.add(new Args(0, 42));
        pairs.add(new Args(1, 42));
    ...
    public void ignore_T1X_jtt_BC_iinc_1() throws Exception {
        initTests();
        List<Args> pairs = new LinkedList<Args>();
        pairs.add(new Args(1, 2));
    ...
    public void ignore_T1X_jtt_BC_iinc_2() throws Exception {
        initTests();
        List<Args> pairs = new LinkedList<Args>();
    ...
    public void ignore_T1X_jtt_BC_iinc_3() throws Exception {
        initTests();
        List<Args> pairs = new LinkedList<Args>();
    ...
    public void ignore_T1X_jtt_BC_iinc_4() throws Exception {
        initTests();
        List<Args> pairs = new LinkedList<Args>();
    ...
    public void ignore_T1X_jtt_BC_iload_0() throws Exception {
        initTests();
        List<Args> pairs = new LinkedList<Args>();
    ...
    public void ignore_T1X_jtt_BC_iload_0_1() throws Exception {
        initTests();
        List<Args> pairs = new LinkedList<Args>();
        pairs.add(new Args(0, 1));
        pairs.add(new Args(-1, 0));
    ...
    public void ignore_T1X_jtt_BC_iload_0_2() throws Exception {
        initTests();
        List<Args> pairs = new LinkedList<Args>();
        pairs.add(new Args(0, 0));
        pairs.add(new Args(-1, -1));
    ...
    public void ignore_T1X_jtt_BC_iload_1() throws Exception {
        initTests();
        List<Args> pairs = new LinkedList<Args>();
        pairs.add(new Args(1, 0));
        pairs.add(new Args(1, -1));
    ...
    public void ignore_T1X_jtt_BC_iload_2() throws Exception {
        initTests();
        List<Args> pairs = new LinkedList<Args>();
    ...
    public void ignore_T1X_jtt_BC_iload_3() throws Exception {
        initTests();
        List<Args> pairs = new LinkedList<Args>();
    ...
    public void ignore_T1X_jtt_BC_ifeq() throws Exception {
        initTests();
        List<Args> pairs = new LinkedList<Args>();
    ...
    public void ignore_T1X_jtt_BC_ifeq_2() throws Exception {
        initTests();
        List<Args> pairs = new LinkedList<Args>();
        pairs.add(new Args(0, 1));
        pairs.add(new Args(1, 0));
    ...
    public void ignore_T1X_jtt_BC_ifeq_3() throws Exception {
        initTests();
        List<Args> pairs = new LinkedList<Args>();
        pairs.add(new Args(0, 0));
        pairs.add(new Args(1, 1));
    ...
    public void ignore_T1X_jtt_BC_ifge() throws Exception {
        initTests();
        List<Args> pairs = new LinkedList<Args>();
        pairs.add(new Args(0, 0));
        pairs.add(new Args(1, 1));
    ...
    public void ignore_T1X_jtt_BC_ifgt() throws Exception {
        initTests();
        List<Args> pairs = new LinkedList<Args>();
        pairs.add(new Args(0, 0));
        pairs.add(new Args(1, 1));
    ...
    public void ignore_T1X_jtt_BC_ifle() throws Exception {
        initTests();
        List<Args> pairs = new LinkedList<Args>();
        pairs.add(new Args(0, 0));
        pairs.add(new Args(1, 1));
    ...
    public void ignore_T1X_jtt_BC_ifne() throws Exception {
        initTests();
        List<Args> pairs = new LinkedList<Args>();
        pairs.add(new Args(0, 0));
        pairs.add(new Args(1, 1));
    ...
    public void ignore_T1X_jtt_BC_iflt() throws Exception {
        initTests();
        List<Args> pairs = new LinkedList<Args>();
        pairs.add(new Args(0, 0));
        pairs.add(new Args(1, 1));
    ...
    public void ignore_T1X_jtt_BC_ificmplt1() throws Exception {
        initTests();
        List<Args> pairs = new LinkedList<Args>();
        pairs.add(new Args(0, 0));
        pairs.add(new Args(1, 1));
    ...
    public void ignore_T1X_jtt_BC_ificmplt2() throws Exception {
        initTests();
        List<Args> pairs = new LinkedList<Args>();
        pairs.add(new Args(0, 0));
        pairs.add(new Args(1, 1));
    ...
    public void ignore_T1X_jtt_BC_ificmpne1() throws Exception {
        initTests();
        List<Args> pairs = new LinkedList<Args>();
        pairs.add(new Args(0, 0));
        pairs.add(new Args(1, 1));
    ...
    public void ignore_T1X_jtt_BC_ifge_3() throws Exception {
        initTests();
        List<Args> pairs = new LinkedList<Args>();
        pairs.add(new Args(0, 1));
        pairs.add(new Args(1, -0));
    ...
    public void ignore_T1X_jtt_BC_ifge_2() throws Exception {
        initTests();
        List<Args> pairs = new LinkedList<Args>();
        pairs.add(new Args(0, 2));
        pairs.add(new Args(1, -2));
    ...
    public void work_jtt_BC_f2d() throws Exception {
    ...
    public void ignore_jtt_BC_b2f() throws Exception {
        CompilationBroker.OFFLINE = initialised;
        CompilationBroker.SIMULATEADAPTER = true;
        initTests();
    ...
    public void work_jtt_BC_d2i01() throws Exception {
    ...
    public void ignore_T1X_jtt_BC_d2i02() throws Exception {
        ...
        for (int i = 0; i < 5; i++) {
           ...
           masm.push(ConditionFlag.Always, 1);
            ...
            Object[] registerValues = generateObjectsAndTestStubs(functionPrototype, 0, masm.codeBuffer.copyData(0, masm.codeBuffer.position()), expectedValues, testvalues,
                            bitmasks);
    ...
    public void work_jtt_BC_i2d() throws Exception {
    ...
    public void work_C1X_jtt_BC_dcmp01() throws Exception {
        CompilationBroker.OFFLINE = initialised;
    ...
    public void work_C1X_jtt_BC_dcmp02() throws Exception {
    ...
    public void work_C1X_jtt_BC_dcmp04() throws Exception {
        initTests();
        CompilationBroker.OFFLINE = initialised;
        double argOne[] = { -1.0d, 1.0d, 0.0d, -0.0d, 5.1d, -5.1d, 0.0d};
    ...
    public void work_C1X_jtt_BC_dcmp05() throws Exception {
        initTests();
        CompilationBroker.OFFLINE = initialised;
        double argOne[] = { -1.0d, 1.0d, 0.0d, -0.0d, 5.1d, -5.1d, 0.0d};
    ...
    public void work_C1X_jtt_BC_dcmp06() throws Exception {
        initTests();
        CompilationBroker.OFFLINE = initialised;
        double argOne[] = { -1.0d, 1.0d, 0.0d, -0.0d, 5.1d, -5.1d, 0.0d};
    ...
    public void work_C1X_jtt_BC_dcmp07() throws Exception {
        initTests();
        CompilationBroker.OFFLINE = initialised;
        double argOne[] = { -1.0d, 1.0d, 0.0d, -0.0d, 5.1d, -5.1d, 0.0d};
    ...
    public void work_C1X_jtt_BC_dcmp08() throws Exception {
        initTests();
        CompilationBroker.OFFLINE = initialised;
        double argOne[] = { -1.0d, 1.0d, 0.0d, -0.0d, 5.1d, -5.1d, 0.0d};
    ...
    public void work_C1X_jtt_BC_dcmp09() throws Exception {
        initTests();
        CompilationBroker.OFFLINE = initialised;
        double argOne[] = { -1.0d, 1.0d, 0.0d, -0.0d, 5.1d, -5.1d, 0.0d};
    ...
    public void work_C1X_jtt_BC_dcmp10() throws Exception {
        initTests();
        CompilationBroker.OFFLINE = initialised;
    ...
    public void work_C1X_jtt_BC_fcmp01() throws Exception {
        initTests();
        CompilationBroker.OFFLINE = initialised;
    ...
    public void work_C1X_jtt_BC_fcmp02() throws Exception {
        initTests();
        CompilationBroker.OFFLINE = initialised;
    ...
    public void work_C1X_jtt_BC_fcmp03() throws Exception {
        initTests();
        CompilationBroker.OFFLINE = initialised;
        float argOne[] = { -1.0f, 1.0f, 0.0f, -0.0f, 5.1f, -5.1f, 0.0f};
    ...
    public void work_C1X_jtt_BC_fcmp04() throws Exception {
        initTests();
        CompilationBroker.OFFLINE = initialised;
        float argOne[] = { -1.0f, 1.0f, 0.0f, -0.0f, 5.1f, -5.1f, 0.0f};
    ...
    public void work_C1X_jtt_BC_fcmp05() throws Exception {
        initTests();
        CompilationBroker.OFFLINE = initialised;
        float argOne[] = { -1.0f, 1.0f, 0.0f, -0.0f, 5.1f, -5.1f, 0.0f};
    ...
    public void work_C1X_jtt_BC_fcmp06() throws Exception {
        initTests();
        CompilationBroker.OFFLINE = initialised;
        float argOne[] = { -1.0f, 1.0f, 0.0f, -0.0f, 5.1f, -5.1f, 0.0f};
    ...
    public void work_C1X_jtt_BC_fcmp07() throws Exception {
        initTests();
        CompilationBroker.OFFLINE = initialised;
        float argOne[] = { -1.0f, 1.0f, 0.0f, -0.0f, 5.1f, -5.1f, 0.0f};
    ...
    public void work_C1X_jtt_BC_fcmp08() throws Exception {
        initTests();
        CompilationBroker.OFFLINE = initialised;
        float argOne[] = { -1.0f, 1.0f, 0.0f, -0.0f, 5.1f, -5.1f, 0.0f};
    ...
    public void work_C1X_jtt_BC_fcmp09() throws Exception {
        initTests();
        CompilationBroker.OFFLINE = initialised;
        float argOne[] = { -1.0f, 1.0f, 0.0f, -0.0f, 5.1f, -5.1f, 0.0f};
    ...
    public void work_C1X_jtt_BC_fcmp10() throws Exception {
        initTests();
        CompilationBroker.OFFLINE = initialised;
    ...
    public void work_jtt_BC_fmul() throws Exception {
        initTests();
    ...
    public void work_jtt_BC_fadd() throws Exception {
        initTests();
    ...
    public void work_jtt_BC_fsub() throws Exception {
        initTests();
        float argsOne[] = { 311.0f, 2f, -2.5f};
        float argsTwo[] = { 10f, 20.1f, -6.01f};
    ...
    public void work_jtt_BC_fdiv() throws Exception {
        initTests();
    ...
    public void work_jtt_BC_ddiv() throws Exception {
        initTests();
 ...
 */
    ...
    public void work_jtt_BC_dsub() throws Exception {
        initTests();
    ...
    public void work_jtt_BC_dsub2() throws Exception {
        initTests();
    ...
    public void work_jtt_BC_lshl() throws Exception {
        CompilationBroker.OFFLINE = initialised;
    ...
    public void work_jtt_BC_lshr() throws Exception {
        CompilationBroker.OFFLINE = initialised;
    ...
    public void ignore_jtt_charComp() throws Exception {
        CompilationBroker.OFFLINE = initialised;
        CompilationBroker.SIMULATEADAPTER = true;
    ...
    public void ignore_jtt_BC_irem2() throws Exception {
        CompilationBroker.OFFLINE = initialised;
        CompilationBroker.SIMULATEADAPTER = true;
        String klassName = getKlassName("jtt.bytecode.BC_irem");
        List<TargetMethod> methods = Compile.compile(new String[] { klassName}, "C1X");
    ...
    public void ignore_jtt_BC_long_tests() throws Exception {
        CompilationBroker.OFFLINE = initialised;
    ...
    public void ignore_jtt_BC_long_le() throws Exception {
        CompilationBroker.OFFLINE = initialised;
        boolean failed = false;
        String klassName = getKlassName("jtt.bytecode.BC_long_tests");
        List<TargetMethod> methods = Compile.compile(new String[] { klassName}, "C1X");
    ...
    public void ignore_jtt_BC_long_ge() throws Exception {
        CompilationBroker.OFFLINE = initialised;
        boolean failed = false;
        String klassName = getKlassName("jtt.bytecode.BC_long_tests");
        List<TargetMethod> methods = Compile.compile(new String[] { klassName}, "C1X");
    ...
    public void ignore_jtt_BC_long_eq() throws Exception {
        CompilationBroker.OFFLINE = initialised;
        boolean failed = false;
        String klassName = getKlassName("jtt.bytecode.BC_long_tests");
        List<TargetMethod> methods = Compile.compile(new String[] { klassName}, "C1X");
    ...
    public void ignore_jtt_BC_long_ne() throws Exception {
        CompilationBroker.OFFLINE = initialised;
        boolean failed = false;
        String klassName = getKlassName("jtt.bytecode.BC_long_tests");
        List<TargetMethod> methods = Compile.compile(new String[] { klassName}, "C1X");
    ...
    public void ignore_jtt_BC_long_gt() throws Exception {
        CompilationBroker.OFFLINE = initialised;
        boolean failed = false;
        String klassName = getKlassName("jtt.bytecode.BC_long_tests");
        List<TargetMethod> methods = Compile.compile(new String[] { klassName}, "C1X");
    ...
    public void ignore_jtt_BC_long_lt() throws Exception {
        CompilationBroker.OFFLINE = initialised;
        String klassName = getKlassName("jtt.bytecode.BC_long_tests");
        List<TargetMethod> methods = Compile.compile(new String[] { klassName}, "C1X");
        CompilationBroker.OFFLINE = true;
    ...
    public void work_jtt_BC_movlong() throws Exception {
        CompilationBroker.OFFLINE = initialised;
    ...
    public void work_jtt_BC_lsub() throws Exception {
        CompilationBroker.OFFLINE = initialised;
    ...
    public void ignore_jtt_BC_fload_5() throws Exception {
        initTests();
    ...
    public void ignore_jtt_BC_dload_9() throws Exception {
        initTests();
        ...
        for (int i = 0; i < argsOne.length; i++) {
            ...
            int expectedValue = rt ? 1 : 0;
            String functionPrototype = ARMCodeWriter.preAmble(
                            "int",
    ...
    public void ignore_jtt_BC_dload_10() throws Exception {
        initTests();
        double argsOne[] = { 0.0D, 1.1D};
        double argsTwo[] = { 17.1D, 2.5D};
        double argsThree[] = { 0.0D, 1.1D};
        ...
        for (int i = 0; i < argsOne.length; i++) {
            ...
            String functionPrototype = ARMCodeWriter.preAmble(
                            "int",
                            "double, double, double, double, double, double, double, double, double, float",
                            Double.toString(argsOne[i]) + "," + Double.toString(argsTwo[i]) + "," + Double.toString(argsThree[i]) + "," + Double.toString(argsFour[i]) + "," +
                                            Double.toString(argsFive[i]) + "," + Double.toString(argsSix[i]) + "," + Double.toString(argsSeven[i]) + "," + Double.toString(argsEight[i]) + "," +
    ...
    public void ignore_jtt_BC_dload() throws Exception {
        initTests();
        double argsOne[] = { 0.0D, 1.1D, -1.4D, 256.33D, 1000.001D};
    ...
    public void ignore_jtt_BC_dload_2() throws Exception {
        initTests();
        double argsOne[] = { 0.0D, 1.1D, -1.4D, 256.33D, 1000.001D};
    ...
    public void ignore_jtt_BC_fdload() throws Exception {
        initTests();
        ...
        for (int i = 0; i < argsOne.length; i++) {
            ...
            String functionPrototype = ARMCodeWriter.preAmble(
                            ...
                            Double.toString(argsOne[i]) + "," + Float.toString(argsTwo[i]) + "," + Double.toString(argsThree[i]) + "," + Float.toString(argsFour[i]) + "," +
                                            Float.toString(argsFive[i]));
            Object[] registerValues = generateObjectsAndTestStubs(functionPrototype, entryPoint, codeBytes, expectedValues, testvalues, bitmasks);
            assert ((Integer) registerValues[0]).intValue() == expectedValue : "Failed incorrect value " + ((Integer) registerValues[0]).intValue() + " " + expectedValue;
            theCompiler.cleanup();
        }
