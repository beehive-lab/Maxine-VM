...
public class ARMV7JTTTest extends MaxTestCase {
    ...
    public void IGNOREtest_jtt_BC_XXXXfdiv() throws Exception {
 ...
 */
    ...
    public void IGNOREFAIL_jtt_BC_XXdneg9() throws Exception {
        initTests();
        boolean failed = false;
  /*
     * @Harness: java
    ...
    public void IGNORE_FAILING_jtt_BC_lload_0() throws Exception {
        CompilationBroker.OFFLINE = initialised;
