...
public class MaxineTesterConfiguration {
    ...
    static {
        ...
        imageConfig("jtt-t1xc1x", opt_c1x,"--J @ \" -Xms512M -Xmx1G -esa -ea\"","-heap=com.sun.max.vm.heap.sequential.semiSpace","-threads=4","-debug-methods",  "-run=test.com.sun.max.vm.jtrun.all",/*"-build=DEBUG",*/ "-native-tests", testCallerT1X);
