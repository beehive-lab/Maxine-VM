 ...
 * Company, Ltd.
 */
/*VCSID=e3538fdc-f7fa-47fe-8ce3-d061fdf3c18a*/
...
public class IdentityHashSetTest extends TestCase {
    ...
    public void test_identityHashSetInt() {
        final IdentityHashSet<Integer> set = new IdentityHashSet<Integer>(1000);
        assertTrue(set.isEmpty());
    }
    ...
    public void test_first() {
        ...
        theFirst = new Integer(99);
        set.add(theFirst);
        assertSame(set.first(), theFirst);
        final Integer[] ints = makeIntegerArray(100);
        set.addAll(Arrays.asList(ints));
        assertTrue(set.contains(set.first()));
    }
    ...
    public void test_length() {
        ...
        final Integer[] ints = makeIntegerArray(100);
        set.addAll(Arrays.asList(ints));
        assertEquals(set.length(), 100);
        set.remove(ints[10]);
        assertEquals(set.length(), 99);
    }
